...
#[derive(Accounts)]
pub struct CreatePoolAndMintToken<'info> {
    #[account(mut)]
...
pub fn create_pool_and_mint_token20(
    ...
    // Initialize pool
    pool.set_inner(LiquidityPool::new1(
